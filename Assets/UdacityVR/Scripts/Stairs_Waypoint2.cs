...
public class Stairs_Waypoint2 : MonoBehaviour
{
    private enum State
    {
        Idle,
    ...
    private Color _color_origional = new Color(0.0f, 0.0f, 1.0f, 0.5f);
    ...
    public void Click()
    {
        ...
        Camera.main.transform.parent.transform.position = new Vector3
            (gameObject.transform.position.x, transform.eulerAngles.y + 13.0f,
